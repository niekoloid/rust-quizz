...
pub trait ResponseHelper {
    ...
    fn set_stop(self, stop: i32);
}
impl ResponseHelper for *mut Response {
    fn set_response_body(self, body: &str) {
        unsafe {
            let ret: *mut libc::c_char = std::ffi::CString::new(body).unwrap().into_raw();
    ...
    fn set_stop(self, stop: i32) {
        unsafe { response_set_stop(self, stop) };
    }
}
...
pub fn startup(callback: extern "C" fn(*mut Request, *mut Response) -> i32) {
    unsafe {
...
extern "C" {
    ...
    pub fn context_set_callback(
        ...
        callback: extern "C" fn(*mut Request, *mut Response) -> i32,
    ) -> *mut libc::c_void;
    ...
    pub fn response_set_stop(request: *mut Response, stop: i32);
